...
<div class="container">
	<div class="row">
	<div class="col-sm-3">
		<a class="text">Iphone 4s<img src="resources/images/iphone4s.png" width="200" height="250"></a>
	</div>
	<div class="col-sm-3">
		<a class="text">Iphone 5s<img src="resources/images/iphone5s.png" width="200" height="250"></a>
	</div>
	<div class="col-sm-3">
		<a class="text">Iphone 6s<img src="resources/images/iphone6s.png" width="200" height="250"></a>
	</div>
	<div class="col-sm-3">
		<a class="text">Iphone 6s Plus<img src="resources/images/iphone6splus.png" width="200" height="250"></a>
	</div>
	</div>
	<div class="row">
	<div class="col-sm-3">
		<a class="text">Iphone 7 COMING SOON <img src="resources/images/iphone7.png" width="200" height="250"></a>
	</div>

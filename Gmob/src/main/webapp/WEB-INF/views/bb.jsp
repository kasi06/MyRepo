...
<div class="container">
	<div class="row">
	<div class="col-sm-3">
		<a class="text">Blackberry Priv<img src="resources/images/blackberry-priv.jpg" width="200" height="250"></a>
	</div>
	<div class="col-sm-3">
		<a class="text">Blackberry DTEK50<img src="resources/images/BlackBerry-DTEK50.jpg" width="200" height="250"></a>
	</div>
	<div class="col-sm-3">
		<a class="text">Blackberry Z3<img src="resources/images/blackberry-Z3.jpg" width="200" height="250"></a>
	</div>
	<div class="col-sm-3">
		<a class="text">Blackberry Z10<img src="resources/images/BlackBerry-Z10.jpg" width="200" height="250"></a>
	</div>
	</div>
	<div class="row">
	<div class="col-sm-3">
		<a class="text">Blackberry Q5<img src="resources/images/blackberry-Q5.png" width="200" height="250"></a>
	</div>
